...
* dbus-next on linux, required to enable MPRIS
...
5. [mpd-now-playable](https://git.00dani.me/00dani/mpd-now-playable) by [00dani](https://git.00dani.me/00dani) - Expose your MPD server as a 'now playable' app on MacOS
